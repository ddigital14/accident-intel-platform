...
function buildHtml(leads, opts) {
  ...
  // Phase 50b: ACC-branded header — inline logomark SVG + wordmark + subtitle
  const accLogoInline = `<svg width="46" height="46" viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle;"><defs><linearGradient id="navyG_email" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#1E3A8A"/><stop offset="100%" stop-color="#0F2A5A"/></linearGradient><linearGradient id="redG_email" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#EF4444"/><stop offset="100%" stop-color="#B91C1C"/></linearGradient></defs><g transform="translate(120,130)"><circle r="92" fill="none" stroke="#0F2A5A" stroke-width="0.6" opacity="0.28"/><circle r="76" fill="none" stroke="#0F2A5A" stroke-width="0.8" opacity="0.42"/><path d="M0 -78 L70 -60 L70 0 Q70 35 0 60 Q-70 35 -70 0 L-70 -60 Z" fill="url(#navyG_email)"/><text x="0" y="12" text-anchor="middle" font-family="Helvetica,Arial,sans-serif" font-size="42" font-weight="500" fill="#FAFAFA" letter-spacing="5">ACC</text><g transform="translate(0,-78)"><circle r="20" fill="#FAFAFA"/><path d="M0 -12 L10 0 L0 12 L-10 0 Z" fill="url(#redG_email)"/><circle r="3" fill="#FAFAFA"/></g></g></svg>`;
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:18px;background:#f6f8fb;border:1px solid #d8e0ee;border-radius:6px;">
    <tr><td style="padding:14px 16px;">
      <table cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="vertical-align:middle;padding-right:12px;">${accLogoInline}</td>
          <td style="vertical-align:middle;">
            <div style="font-size:22px;font-weight:bold;color:#0F2A5A;letter-spacing:-0.3px;">Accident Command Center</div>
            <div style="font-size:11px;font-weight:600;color:#64748B;letter-spacing:1.5px;text-transform:uppercase;margin-top:2px;">by Donovan Digital Solutions</div>
          </td>
        </tr>
      </table>
      <div style="font-size:13px;color:#444;margin-top:10px;border-top:1px solid #d8e0ee;padding-top:10px;">${subjectLine}${admin ? ' <span style="color:#a06600;">(ADMIN VIEW \u2014 includes raw cost / source / confidence)</span>' : ''}</div>
    </td></tr>
  </table>`;
  ...
  <div style="margin-top:24px;padding:12px 14px;background:#fafafa;border:1px solid #eee;border-radius:6px;font-size:12px;color:#555;">
    ...
    <div style="margin-top:8px;padding-top:8px;border-top:1px solid #eee;text-align:center;color:#0F2A5A;font-weight:600;letter-spacing:0.5px;">
      by Donovan Digital Solutions \u00b7 <a href="https://accidentcommandcenter.com" style="color:#0F2A5A;text-decoration:none;">accidentcommandcenter.com</a>
    </div>
  </div>`;
