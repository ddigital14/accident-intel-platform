...
const ENGINE_CATALOGUE = {
  ...
  'text-extractors':     { needs:['any'],              produces:['phone','address','vin','plate','insurance'], cost:0, speed:'fast' },
  'opencnam':            { needs:['phone'],            produces:['caller_id_name'], cost:0,                 speed:'fast' },
  'whitepages-scrape':   { needs:['name','state'],     produces:['ages','cities'], cost:0,                  speed:'medium' },
  'attorney-cross-link': { needs:['attorney_firm'],    produces:['case_ring'], cost:0,                      speed:'fast' },
  'hunter-campaign':     { needs:['email'],            produces:['email_sent'], cost:0,                     speed:'fast' },
