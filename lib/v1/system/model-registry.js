...
const DEFAULTS = {
  ...
  light_extraction: 'gpt-4o-mini',
  heavy_extraction: 'gpt-4o',
  cross_reasoning: 'claude-opus-4-7',           // upgraded from sonnet-4-6
  premium_reasoning: 'claude-opus-4-7',
  embedding: 'text-embedding-3-small',
  classification: 'gpt-4o-mini',
  ...
  fatal_extraction: 'claude-opus-4-7',          // upgraded from gpt-4o for fatal reads
  identity_validation: 'claude-opus-4-7',       // upgraded from sonnet-4-6
  spanish_extraction: 'gpt-4o',                 // new task for Spanish NER
  fraud_detection: 'claude-opus-4-7',           // new task for fraud filter context analysis
  family_tree_ner: 'claude-opus-4-7'            // new task for surviving-family extraction
};
