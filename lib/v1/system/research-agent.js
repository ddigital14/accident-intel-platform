...
const TOOLS = {
  ...
  local_news_search: { fn: tool_local_news_search, params: { name: 'string', city: 'string', state: 'string?' },
    description: '*** PRIORITIZE THIS TOOL when city is known *** — direct fetch of local newspaper search pages (IndyStar, NY Post, LA Times, Chicago Tribune, Houston Chronicle, AJC, Miami Herald, Tampa Bay Times, Orlando Sentinel, AZ Central, LV Review-Journal, Seattle Times, Boston Globe, Inquirer, Detroit Free Press, Denver Post, Dallas News, NJ.com, Cleveland.com, Akron Beacon Journal, Cincinnati Enquirer, STL Today, Pittsburgh Post-Gazette, Charlotte Observer, Tennessean, Star Tribune, Oregonian, SF Chronicle, San Diego UT, Sac Bee, etc — 30 metros, 68 papers). Bypasses Brave\'s sparse small-market indexing. Returns top articles with full body text. Best chance of finding local accident coverage with named victim/family.'
};
