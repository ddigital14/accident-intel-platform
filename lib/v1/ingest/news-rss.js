...
// Crash keyword filter (cheap pre-filter before GPT)
// Phase 24 — PI-broad keyword filter (vehicle, pedestrian, water, workplace, premises, medical, product, catastrophic).
// Word-boundary matching, case-insensitive. Intent-driven: capture ANY personal-injury lead.
const CRASH_KEYWORDS = /\b(?:crash|accident|collision|wreck|wrecked|rollover|hit[- ]and[- ]run|t[- ]boned?|rear[- ]ended?|head[- ]on|sideswipe|ejected|overturned|jackknife|jackknifed|pileup|pile[- ]up|fender[- ]bender|car|truck|semi|big[- ]rig|18[- ]wheeler|tractor[- ]trailer|motorcycle|motorcyclist|biker|bike|bicycle|bicyclist|cyclist|scooter|e[- ]bike|moped|atv|utv|rv|pedestrian|jogger|runner|walker|crosswalk|boat|boating|jet[- ]ski|kayak|drowned?|drowning|marine|construction|scaffolding|scaffold|fall|fell|slip[- ]and[- ]fall|slipped|tripped|osha|workplace|machinery|forklift|electrocut(?:ed|ion)|premises|dog[- ]bite|elevator|escalator|swimming[- ]pool|pool|malpractice|surgery|surgical|misdiagnos(?:is|ed)|hospital|er|ambulance|emt|paramedic|defective|recall|recalled|exploded|explosion|faulty|malfunction|injured|injury|injuries|killed|kills|dead|deadly|fatal|fatalit(?:y|ies)|hospitalized|critical|life[- ]threatening|trooper|state[- ]police|police|sheriff|trauma|paralyzed|paralyzes|brain[- ]injur|spinal|amputat|amputee|burn|burns|burned|dui|dwi|drunk[- ]driv|impaired[- ]driv|reckless|negligen(?:t|ce)|wrongful[- ]death|tort|personal[- ]injur)\b/i;
