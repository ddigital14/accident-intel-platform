...
const STATES = [
  // TxDOT killed the legacy /api/Incident endpoint — use ArcGIS feature service backing 511.tx.gov
  { code: 'TX', name: 'Texas',  feedUrl: 'https://services1.arcgis.com/KTcxiTD9dsQw4r7Z/arcgis/rest/services/Active_Crashes/FeatureServer/0/query?where=1%3D1&outFields=*&f=json&resultRecordCount=200', parser: 'arcgis_tx' },
  // 511GA requires a key; skip until we have one (graceful no-op)
  { code: 'GA', name: 'Georgia', feedUrl: 'https://www.511ga.org/api/v2/getevents?format=json', parser: 'ga511', enabled: false },
  // FL511 — public events JSON
  { code: 'FL', name: 'Florida', feedUrl: 'https://fl511.com/map/data/Events?eventCategory=Crash', parser: 'fl511_v2', enabled: false }
];
...
const PARSERS = { txdot: parseTxDOT, ga511: parseGa511, fl511: parseFl511, arcgis_tx: parseArcGisTx, fl511_v2: parseFl511V2 };
